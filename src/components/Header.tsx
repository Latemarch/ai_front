...
export default function Header() {
  return (
    <div className="flex h-16 shrink-0 text-white font-semibold items-center justify-center px-6 top-0 w-full z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
      {/* Navigation Links */}
